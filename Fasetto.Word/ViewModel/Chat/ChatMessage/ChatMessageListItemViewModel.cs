...
namespace Fasetto.Word
{
    ...
    public class ChatMessageListItemViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// A flag indicating if this item was added since the first main list items was created
        ...
        /// <summary>
        /// A flag indicationg if we have a any message text or not
        /// </summary>
        public bool HasMessage => Message != null;

        /// <summary>
        /// A flag indicationg if we have an image attached to this message
        /// </summary>
